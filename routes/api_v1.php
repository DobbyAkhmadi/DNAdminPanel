...
use App\Http\Controllers\API\v1\BadWordController;
...
Route::controller(BadWordController::class)->middleware(['auth:sanctum'])->group(function () {
    Route::get('/bad-word/detail', 'index');
    Route::post('/bad-word/import', 'import');
    Route::post('/bad-word/export', 'export');
});

Route::controller(TranslateController::class)->middleware(['auth:sanctum'])->group(function () {
    Route::get('/translate/detail', 'index');
    Route::post('/translate/import', 'import');
    Route::post('/translate/export', 'export');
});
